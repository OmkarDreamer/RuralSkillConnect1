  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (email === "client@example.com" && password === "password123") {
        ...
        localStorage.setItem("auth_token", "demo_client_token")
        localStorage.setItem("user_type", "client")
        localStorage.setItem("user_name", "Rahul Sharma")
      ...
      } else if (email === "worker@example.com" && password === "password123") {
        // Store auth token in localStorage (in a real app, this would be a JWT)
        localStorage.setItem("auth_token", "demo_worker_token")
        localStorage.setItem("user_type", "worker")
        localStorage.setItem("user_name", "Priya Patel")

        toast({
          title: "Login successful",
          description: "Welcome back, Priya Patel!",
          variant: "default",
        })
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-neutral-beige p-4 relative">
      ...
      <Card className="w-full max-w-md relative z-10 shadow-medium">
        <CardHeader className="space-y-1">
          ...
          <CardTitle className="text-2xl font-bold text-center text-primary-blue">Welcome back</CardTitle>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              <Label htmlFor="remember" className="text-sm text-neutral-charcoal">
                Remember me
              </Label>
            </div>
            <Button
            ...
            <div className="text-sm text-center text-neutral-gray mt-2">
              <p>Demo Accounts:</p>
              <p>Client: client@example.com / password123</p>
              <p>Worker: worker@example.com / password123</p>
            </div>
          </form>
        </CardContent>
